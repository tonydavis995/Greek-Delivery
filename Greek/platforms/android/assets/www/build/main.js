...
var MySplashPage = /** @class */ (function () {
    ...
    MySplashPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-mysplash',template:/*ion-inline-start:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/pages/mysplash/mysplash.html"*/'<ion-content>\n    <img src="assets/imgs/splash.png">\n</ion-content>'/*ion-inline-end:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/pages/mysplash/mysplash.html"*/
        }),
...
var ConfirmedPage = /** @class */ (function () {
    ...
    ConfirmedPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-confirmed',template:/*ion-inline-start:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/pages/confirmed/confirmed.html"*/'<ion-header class="bg-transparent">\n\n    <ion-navbar>\n\n        <ion-title></ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n\n\n\n\n<ion-content text-center>\n\n    <figure>\n\n        <img src="assets/imgs/fishing.gif">\n\n    </figure>\n\n    <h2>{{\'order_confirmed\' | translate}}!</h2>\n\n    <div  class="fixed-bottom" >\n\n        <h2>{{\'Share Your Location for Faster Delivery\'}}</h2>\n\n        <button ion-button full class="btn" (click)="proceed()">\n\n        <a  style="text-decoration: none;color:white;"  href="https://api.whatsapp.com/send?phone=917012800595"> <ion-icon class="icon" ios="ios-pin" md="md-pin"></ion-icon> \n\n        {{\'Share your location to Whatsapp\'}}</a></button>\n\n    </div>\n\n    \n\n</ion-content>\n\n'/*ion-inline-end:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/pages/confirmed/confirmed.html"*/,
        }),
...
var CodePage = /** @class */ (function () {
    ...
    CodePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-code ',template:/*ion-inline-start:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/pages/code/code.html"*/'<ion-content class="bg-light">\n\n    <div class="code">\n\n        <h2>{{\'Add Promo code\' | translate}}</h2>\n\n        <ion-input type="text" value="" [(ngModel)]="cCode" placeholder="Enter promo code here"></ion-input>\n\n        <button ion-button full class="btn-round btn-text btn btn-green" (click)="checkCode()">{{\'submit\' | translate}}</button>\n\n    </div>\n\n</ion-content>'/*ion-inline-end:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/pages/code/code.html"*/,
...
var FavoritesPage = /** @class */ (function () {
    ...
    FavoritesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-favorites',template:/*ion-inline-start:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/pages/favorites/favorites.html"*/'<ion-header>\n\n\n\n    <ion-navbar>\n\n        <ion-title>{{\'favorite\' | translate}}</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n    <ion-list *ngIf="products && products.length" no-lines>\n\n        <ion-item *ngFor="let pro of products">\n\n            <ion-thumbnail item-start>\n\n                <figure *ngIf="pro.images && pro.images.length" (click)="itemsinfo(pro)">\n\n                    <img data-src="{{pro.images[0].src}}">\n\n                </figure>\n\n                <figure *ngIf="!pro.images || !pro.images.length" (click)="itemsinfo(pro)">\n\n                    <img src="assets/imgs/img_1.png">\n\n                </figure>\n\n            </ion-thumbnail>\n\n            <h2 (click)="itemsinfo(pro)">{{pro.name}}</h2>\n\n            <p (click)="itemsinfo(pro)" [innerHTML]="pro.short_description"></p>\n\n            <ion-row>\n\n                <ion-col col-12 class="text-green">\n\n                    <p *ngIf="pro.type == \'simple\'" [innerHTML]="pro.sale_price_html"></p>\n\n                    <p *ngIf="pro.type == \'variable\'" [innerHTML]="pro.price_html"></p>\n\n                </ion-col>\n\n            </ion-row>\n\n        </ion-item>\n\n    </ion-list>\n\n\n\n    <div *ngIf="!products || !products.length" class="empty">\n\n        <div>\n\n            <img src="assets/imgs/empty.png">\n\n            <p>{{\'favorite_empty\' | translate}}!</p>\n\n        </div>\n\n    </div>\n\n\n\n</ion-content>'/*ion-inline-end:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/pages/favorites/favorites.html"*/,
            providers: [__WEBPACK_IMPORTED_MODULE_3__providers_global__["a" /* Global */]]
        }),
...
var AboutPage = /** @class */ (function () {
    ...
    AboutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-about',template:/*ion-inline-start:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/pages/about/about.html"*/'<ion-header class="bg-transparent">\n\n    <ion-navbar>\n\n        <ion-title>{{\'about\' | translate}}</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content class="bg-light">\n\n    <div class="img-box">\n\n        <img src="assets/imgs/restroimage.png">\n\n    </div>\n\n    <ion-card>\n\n        <p>{{\'about1\' | translate}}</p>\n\n        <p>{{\'about2\' | translate}}</p>\n\n    </ion-card>\n\n    <ion-card>\n\n        <p>{{\'about3\' | translate}}</p>\n\n        <p>{{\'about4\' | translate}}</p>\n\n    </ion-card>\n\n</ion-content>\n\n'/*ion-inline-end:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/pages/about/about.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */]])
    ], AboutPage);
    return AboutPage;
...
var TncPage = /** @class */ (function () {
    ...
    TncPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-tnc',template:/*ion-inline-start:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/pages/tnc/tnc.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>{{\'tnc\' | translate}}</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content class="bg-light">\n\n  <ion-card class="card logo">\n\n    <div class="img-box" text-center>\n\n      <img src="assets/imgs/logo.png" class="logo">\n\n    </div>\n\n  </ion-card>\n\n  <ion-card>\n\n    <h2>{{\'tnc_use\' | translate}}</h2>\n\n    <p>{{\'tnc_use_ext\' | translate}}.</p>\n\n\n\n    <h2>{{\'tnc_billing\' | translate}}</h2>\n\n    <p>{{\'tnc_billing_text\' | translate}}</p>\n\n  </ion-card>\n\n</ion-content>'/*ion-inline-end:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/pages/tnc/tnc.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */]])
    ], TncPage);
    return TncPage;
...
var WalkthoughPage = /** @class */ (function () {
    ...
    WalkthoughPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-walkthough',template:/*ion-inline-start:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/pages/walkthough/walkthough.html"*/'<ion-content padding>\n\n    <ion-slides pager>\n\n        <ion-slide>\n\n            <img src="./assets/imgs/screen2.png" class="slide-image" />\n\n            <h2 class="text-heading" innerHTML="{{\'walk_first_title\' | translate}}"></h2>\n\n            <span (click)="finish()" class="text-light">{{ "skip" | translate }}</span>\n\n        </ion-slide>\n\n        <ion-slide>\n\n            <img src="./assets/imgs/screen1.png" class="slide-image" />\n\n            <h2 class="text-heading" innerHTML="{{\'walk_second_title\' | translate}}"></h2>\n\n            <span (click)="finish()" class="text-light">{{ "Finish" | translate }}</span>\n\n        </ion-slide>\n\n       \n\n    </ion-slides>\n\n</ion-content>'/*ion-inline-end:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/pages/walkthough/walkthough.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* Events */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */],
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/app/app.html"*/,
            providers: [__WEBPACK_IMPORTED_MODULE_6__providers_wordpress_client_service__["a" /* WordpressClient */]]
        }),
...
var TabsPage = /** @class */ (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/pages/tabs/tabs.html"*/'<ion-tabs [selectedIndex]="0" #tabs>\n    <ion-tab [root]="tab1Root" tabTitle="" tabIcon="md-list-box" tabsHideOnSubPages="true"></ion-tab>\n    <ion-tab [root]="tab2Root" tabTitle="" tabIcon="md-search" tabsHideOnSubPages="true"></ion-tab>\n    <ion-tab [root]="tab3Root" tabTitle="{{cartCount}}" tabIcon="md-basket" tabsHideOnSubPages="true"></ion-tab>\n    <ion-tab [root]="tab4Root" tabTitle="" tabIcon="md-heart" tabsHideOnSubPages="true"></ion-tab>\n    <ion-tab [root]="tab5Root" tabTitle="" tabIcon="md-person" tabsHideOnSubPages="true"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/pages/tabs/tabs.html"*/,
...
var PaymentPage = /** @class */ (function () {
    ...
    PaymentPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-payment',template:/*ion-inline-start:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/pages/payment/payment.html"*/'<!--\n\n  Generated template for the PaymentPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>{{"payment" | translate}}</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"/Users/vinayaknair/Desktop/codecanyon-22364393-restaurant-woocommerce-android-ios-full-application-foodmall/App Source Code/Greek/src/pages/payment/payment.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */]])
    ], PaymentPage);
    return PaymentPage;
...
var CartPage = /** @class */ (function () {
    function CartPage(modalCtrl, translateService, events, global, navCtrl, toastCtrl) {
        this.modalCtrl = modalCtrl;
        this.translateService = translateService;
        this.events = events;
        this.global = global;
    ...
    CartPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* ModalController */], __WEBPACK_IMPORTED_MODULE_6__node_modules_ngx_translate_core__["c" /* TranslateService */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* Events */], __WEBPACK_IMPORTED_MODULE_3__providers_global__["a" /* Global */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */],
